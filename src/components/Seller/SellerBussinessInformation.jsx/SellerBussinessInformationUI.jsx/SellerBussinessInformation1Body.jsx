...
function SellerBussinessInformation1Body() {
  ...
  const handleNavigate = (e) => {
    e.preventDefault();
    navigate("/SellerPaymentInformation");
  };
          ...
          <div className="flex lg:flex-row flex-col lg:gap-32 gap-16 mt-[101px]">
            ...
            <div className="flex justify-end flex-col gap-[13px] w-full">
              <button
                ...
                className="lg:w-[372px] w-full h-[77px] bg-[#ADBC9F] rounded-[15px] md:text-[24px] md:leading-[34.8px] text-[20px] leading-[29px] font-semibold text-white"
              >
                Send Code
              </button>
            </div>
...
export default SellerBussinessInformation1Body;
