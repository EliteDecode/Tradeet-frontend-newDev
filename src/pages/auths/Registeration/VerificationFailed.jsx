              ...
              {[...Array(6)].map((_, index) => (
                <input
                  ...
                  className="md:w-[55px] md:h-[55px] w-[45px] h-[45px] text-[#777777] text-lg text-center 
								rounded-[15px] border-[#EB4335] border"
                />
              ))}
            </div>

            <div className="flex justify-between md:gap-8 gap-5 md:mt-5 mt-3">
              <p className="md:text-[14px] text-[12px] text-[#EB4335] font-normal leading-[20px]">
                Wrong code please try again
              </p>
              <span className="md:text-[14px] text-[12px] text-[#2D2D2D]">
                Resend code in:{" "}
                <span className="text-[#12362A] font-medium">00:20</span>
              </span>
            </div>
