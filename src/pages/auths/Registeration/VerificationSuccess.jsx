...
const VerificationSuccess = () => {
  ...
  return (
    <div>
      <div id="confirm__number" className="mb-16 p-4">
        <div className="flex justify-center items-center mt-4 md:mt-28 w-full">
          <div
          ...
          >
            ...
            <div className="flex justify-between items-start md:gap-4 gap-2 mt-4 ">
              {[...Array(6)].map((_, index) => (
                <input
                  ...
                  type="text"
                  maxLength="1"
                  className="md:w-[55px] md:h-[55px] w-[45px] h-[45px] text-[#777777] text-lg text-center 
								rounded-[15px] border-[#12362A] border"
                />
              ))}
              <img src={Verified} alt="Verify icon" />
            </div>

            <div className="flex justify-between md:gap-8 gap-5 md:mt-5 mt-3">
              <p className="md:text-[14px] text-[12px] text-[#12362A] font-semibold leading-[20px]">
                Resend Code
              </p>
              <span className="md:text-[14px] text-[12px] text-[#2D2D2D]">
                Code expires:{" "}
            ...
            {/* Continue button */}
            <Link to="/auth/successful">
              <button className="bg-[#12362a] md:w-[450px] w-full h-[46px] rounded-[8px] mt-8">
