...
const PopularItems = () => {
  ...
  return (
    <div className="md:px-6">
      <div className="flex gap-6 md:justify-normal justify-between px-8 ">
        <p className="md:text-[32px] text-[24px] text-[#2D2D2D] font-semibold ">
          Popular
        </p>
        <button className="md:text-base text-[14px] text-[#12362A] underline">
          See all items
        </button>
      </div>
      ...
      <div className="h-[360px] relative">
        <div className="mx-auto overflow-hidden">
          <Slider {...settings} className="md:px-10 py-5">
            {products.map((val, i) => (
              <div className="" key={i}>
